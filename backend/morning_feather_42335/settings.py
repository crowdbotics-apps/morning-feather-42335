"""
Django settings for morning_feather_42335 project.
...
ROOT_URLCONF = 'morning_feather_42335.urls'
...
WSGI_APPLICATION = 'morning_feather_42335.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_feather_42335 API",
    "DESCRIPTION": "API documentation for morning_feather_42335 App",
    "VERSION": "v1",
}
